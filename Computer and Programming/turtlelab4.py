...
class Task:
    ...
    You must define two functions: make_square(size) and make_triangle(size)
    """
    ...
    TESTS = [
        ...
        { 
            "funcs" : "make_square,make_triangle",
            "cmd"   : "turtle.left(30); make_square(120); turtle.left(90);"
                      "turtle.forward(120); turtle.right(90); make_triangle(120)",
            "sol"   : {
